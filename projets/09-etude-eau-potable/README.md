...
Attendus techniques (minimum)  
- Visuels utilisés : line plot, scatter plot, grouped barplot, stacked barplot (ou percent stacked)  
- Une représentation temporelle (évolution)  
- Une représentation géographique (carte) si retenue (option)  
- 4 filtres minimum : 
  - 1 quantitatif
  - 1 qualitatif
  - 1 temporel
  - 1 géographique (si carte)
- 1 agrégation / champ calculé (ex : moyenne, conversion d’unités, x1000, etc.)  
- 1 jointure entre fichiers  
- Critères d’accessibilité respectés (lisibilité, simplicité, cohérence visuelle)
